        ...
        <section class="inner-page">
            <div class="container">
                <div class="page-title">
                    <h1>Youth <span>Development</span></h1>
                </div><!-- Page Title -->
                <ul class="gallery-tabs nav nav-tabs" id="myTab">
                    <li class=""><a data-toggle="tab" href="#Programme1">Abuja</a></li>
                    <li class=""><a data-toggle="tab" href="#Programme2">Kaduna</a></li>
                    <li class="active"><a data-toggle="tab" href="#Programme3">Youth Development Anambra</a></li>
                ...
                <div class="gallery-content tab-content" id="myTabContent">
                    ...
                    <div id="Programme3" class="tab-pane fade active in">
                        <div class="row">
                            <div class="well" style="text-align: center;">
