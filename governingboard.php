...
<div class="theme-layout">
				...
				<div class="responsive-header">	
					...
					<div class="responsive-logomenu">
						<div class="container"> 
							<a href="index.html" title=""><img src="images/logo.png" alt="Logo" width="60" height="60"><h1 style="color: #e3c60a;"><i>CENSTLEYO</i></h1></a>
...
<section class="inner-page" style="margin-bottom: 30px;">
		<div class="container">
                <div class="page-title">
                    <h1>Governing Board / <span>Trustee</span></h1>
                </div><!-- Page Title -->
		<div class="row">
		<div class="turn">
				<div class="col-md-5 col-sm-5 col-lg-5 clearfix offset-2" style="text-align: center;">
						<img src="images/uchenna.jpg" class="img-circle" width="200px" height="200px">
						<h3>Uchenna Achinnu</h3>
						<p>Chairman of the Governing Board</p>
					</div>
					<div class="col-md-5 col-sm-5 col-lg-5 clearfix offset-2" style="text-align: center;">
							<img src="images/Augustine.jpg" class="img-circle" width="200px" height="200px">
							<h3>Augustine Job</h3>
