...
<body>
	...
	<section class="inner-page" style="margin-bottom: 30px;">
		<div class="container">
			...
			<div class="row">
				<div class="turn" id="">
					<div class="row">
						<div class="col-md-3 col-sm-3 col-lg-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mr. Emmanuel I.</h3>
							<p>Director of Finance</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Uzor R. Miracle.jpg" class="img-circle" width="200px" height="200px">
							<h3>Uzor R. Miracle</h3>
							<p>Director of Communication</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mr. Emmanuel I.</h3>
							<p>Director of Social/Talent Development</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Alhaji Abdullahi Bayero Director political development.jpg" class="img-circle" width="200px" height="200px">
							<h3>Alhaji Abdullahi Bayero</h3>
							<p>Director of political development</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Abah Martha.jpeg" class="img-circle" width="200px" height="200px">
							<h3>Abah Martha Gabriel.</h3>
							<p>Director of Morals</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mrs. Seconda Amaka</h3>
							<p>Director of International Partnership</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mr. Emmanuel I.</h3>
							<p>Director of Economic Empowerment</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mrs. Seconda Amaka</h3>
							<p>Director of Business Initiatives</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
						...
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mrs. Seconda Amaka</h3>
							<p>Director of Gender Development</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mr. Emmanuel I.</h3>
							<p>Director of Community Service</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mrs. Seconda Amaka</h3>
							<p>Director of Cultural Service</p>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
						...
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/comrade.jpeg" class="img-circle" width="200px" height="200px">
							<h3>Comrade. Obiagbasgu Nicholas A.</h3>
							<p>Director of Medicals</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mr. Emmanuel I.</h3>
							<p>Director of Capital Development</p>
						</div>
						<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
							<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
							<h3>Mrs. Seconda Amaka</h3>
							<p>Director of Enrollment and Statistics</p>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
						<img src="images/Barr. Ngene.jpeg" class="img-circle" width="200px" height="200px">
						<h3>Barr. Ngene Eunice</h3>
						<p>Director of Legals</p>
					</div>
					<div class="col-md-3 col-sm-3 col-lg-3" style="text-align: center;">
						<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
						<h3>Mrs. Seconda Amaka</h3>
	...
	<div class="container" style="margin-bottom: 30px;">
		<div class="col-md-3 col-sm-3 col-lg-3 col-sm-3 col-3">
