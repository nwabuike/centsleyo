                    ...
                    <li class="has-dropdown"><a href="#" title="">Project</a>
                        <ul>
                            ...
                            <li class="has-dropdown"><a href="#">School Programme</a>
                                <ul class="drop-right">
                                    <li><a href="404page.php" title="">Project Head</a></li>
                                    <li><a href="404page.php" title="">Scope</a></li>
        ...
        <section class="inner-page">
            <div class="container">
                <div class="page-title">
                    <h1>Campus <span>Project</span></h1>
                </div><!-- Page Title -->
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide1.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide2.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide3.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide4.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide5.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide6.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide7.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide8.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide9.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide10.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide11.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide12.JPG" width="100%" height="100%">
                    </div>
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <img src="images/campus/Slide13.JPG" width="100%" height="100%">
                    </div>
                </div>
            </div>
        </section>
