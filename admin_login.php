		...
		<div class="theme-layout">
				...
				<div class="responsive-header">	
					...
					<div class="responsive-logomenu">
						<div class="container">
							<a href="index.html" title=""><img src="images/logo.png" alt="Logo"   width="40" height="40"></a>
					...
					<div class="responsive-menu">
						...
						<ul>
							...
							<li class="has-dropdown"><a href="./index.html" title="">Project</a></li>
...
<?php endif ?>
			...
			<div class="footer-bottom style2">
				<div class="container">
					<p>Copyright Ã‚Â© 2019 Global News. <span>All rights reserved.</span> </p>
					<ul>
