...
<head>
	...
	<meta name="keywords"
		content="Admin, Datatables, Dashboard, Bootstrap4, Sass, CSS3, HTML5, Responsive Dashboard, Responsive Admin Template, Admin Template, Best Admin Template, Bootstrap Template" />
	<meta name="author" content="Bootstrap Gallery" />
	<link rel="shortcut icon" href="img/favicon.ico" />
	<title>Censtleyo Admin Dashboard - Datatables</title>
...
<body>
	...
	<div class="app-wrap">
		...
		<div class="app-container">
			...
			<div class="app-main">
				...
				<div class="main-content">
					<div class="row gutters">
							...
							<div class="card">
								<div class="card-body">
									<div class="stats-widget">
											<a href="members.php" class="stats-label" data-toggle="tooltip" data-placement="top" title="New Followers">52</a>
										...
										<div class="stats-widget-body">
											...
											<ul class="row no-gutters">
												<li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
													<h6 class="title">Registered Users</h6>
												</li>
												<li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
													<h4 class="total"><?php 
														global $db;
													...
													$comment = mysqli_num_rows($connStatus);
													echo $comment;
														 ?></h4>
												</li>
											</ul>
						...
						<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
							<div class="card">
								<div class="card-body">
									<div class="stats-widget">
											<a href="blogfunctions/topic.php" class="stats-label" data-toggle="tooltip" data-placement="top" title="Comments"><?php echo $comment;?></a>
										<div class="stats-widget-header">
										...
										<div class="stats-widget-body">
											...
											<ul class="row no-gutters">
												<li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
													<h6 class="title">Published comments</h6>
												</li>
												<li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
													<h4 class="total"><?php 
														global $db;
														$sql =("SELECT count(*) as total_record FROM comments");
														$connStatus =$db ->query($sql);
													$comment = mysqli_num_rows($connStatus);
													echo $comment;
														 ?></h4>
						...
						<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
								<div class="card">
									<div class="card-body">
										<div class="stats-widget">
											<a href="blogfunctions/posts.php" class="stats-label" data-toggle="tooltip" data-placement="top" title="New Post"><?php echo $comment;?></a>
											<div class="stats-widget-header">
											...
											<div class="stats-widget-body">
												...
												<ul class="row no-gutters">
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
														<h6 class="title"> Published   Posts</h6>
													</li>
													<li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
														<h4 class="total"><?php 
															global $db;
					...
					<div class="btn">
							<a href="./blogfunctions/usersAdmin.php" class="btn btn-primary">Add Users</a>
							<a href="./blogfunctions/posts.php" class="btn btn-primary">Add Posts</a>
						</div>
		...
		<footer class="main-footer fixed-btm">
			Copyright Censtleyo <?php echo date('Y'); ?>.
		</footer>
		<!-- END: .main-footer -->
	</div>
	<!-- END: .app-wrap -->
