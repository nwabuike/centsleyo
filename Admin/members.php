<?php include('./membersfunctions/Adminactive.php'); ?>
<!doctype html>
<html lang="en">
            ...
            <div class="main-content">
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">All Memebers</div>
                            <div class="card-body">
                                ...
                                <table id="apiCallbacks" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['dateo_birth']; ?></td>
                                        <td><?php echo $row['gender']; ?></td>
                                        <td><?php echo $row['email']; ?></td>
                                        <td><?php echo $row['image']; ?></td>
                                        <td><?php echo $row['nationality']; ?></td>
                                        <td>
                                            <a href="./membersfunctions/editmember.php?edit=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a>
                                        </td>
                                        <td>
                                            <a href="members.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </table>
