							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav justify-content-center">
										...
										<li class="nav-item">
											<a class="nav-link active" href="./create_post.php">Create Posts</a>
										</li>
										<li class="nav-item">
											<a class="nav-link " href="./posts.php">Manage Posts</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="./usersAdmin.php">Manage Users</a>
										</li>
										<li class="nav-item">
							...
							<form method="post" enctype="multipart/form-data" action="create_post.php">
								...
								<?php endif ?>
										<div class="form-group m-0">
											<input class="form-control" value="<?php echo $title; ?>" name="title"
												type="text" placeholder="Title input hereâ€¦" >
										</div>
								...
								<div class="form-group">
									...
									<select name="topic_id" multiple class="form-control"
								...
								<div class="form-group">
									<div class="form-check">
										<label class="form-check-label" for="publish">
											<input class="form-check-input" value="1" name="publish" type="checkbox"
												checked="checked">Publish
										</label>
									</div>
								</div>
								<?php else: ?>
