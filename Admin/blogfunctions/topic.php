<?php  include('topics_function.php'); ?>
<!doctype html>
<html lang="en">
	...
	<div class="app-wrap">
		...
		<div class="app-container">
						...
						<div class="row">
							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
								...
								<div class="page-title">
									<h5>Create &amp; Edit Topics</h5>
									<h6 class="sub-heading">Welcome to Censtleyo Admin Template</h6>
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<ul class="nav justify-content-center">
										...
										<li class="nav-item">
											<a class="nav-link active" href="./topic.php">Manage Topics</a>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" name="topic_name" value="<?php echo $topic_name; ?>"
											class="form-control is-valid" id="isValid" placeholder="Enter Your Topics">
									</div>
									<!-- if editing topic, display the update button instead of create button -->
									<?php if ($isEditingTopic === true): ?>
									<button type="submit" class="btn btn-primary" name="update_topic">UPDATE</button>
									<?php else: ?>
									<button type="submit" class="btn btn-primary" name="create_topic">Save
										Topic</button>
									<?php endif ?>
							</form>
						</div>
			...
			<footer class="main-footer fixed-btm">
				Copyright Censtleyo Admin <?php echo date('Y') ?>.
			</footer>
			<!-- END: .main-footer -->
		</div>
		<!-- END: .app-wrap -->
