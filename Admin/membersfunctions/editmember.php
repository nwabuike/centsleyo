						...
						<ul class="header-actions">
							...
							<li class="dropdown">
								<a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
									<img class="avatar" src="<?php echo $_SESSION['user']['image']; ?>" alt="User Thumb">
			...
			<aside class="app-side" id="app-side">
				...
				<div class="side-content ">
					...
					<div class="user-profile">
						<img src="<?php echo $_SESSION['user']['image']; ?>" class="profile-thumb" alt="User Thumb">
			...
			<div class="app-main">
				...
				<div class="main-content">
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
						<div class="card">
							<div class="card-header">Table Inverse Header</div>
								<div class="card-body">
									<form class="form-horizontal" role="form" name="register" method="post" action="./Adminactive.php" enctype="multipart/form-data">
										<?php
										$record = getMember($db, $_GET['edit']);
										?>
										<h2>Registration</h2>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" id="lastName" value="<?php echo $record['fullname']; ?>" name="fullname" required placeholder="Last Name" class="form-control" autofocus>
											</div>
										</div>
										<div class="form-group">
											<label for="email" class="col-sm-3 control-label">Email* </label>
											<div class="col-sm-9">
												<input type="email" id="email" required value="<?php echo $record['email']; ?>" placeholder="Email" class="form-control" name="email">
											</div>
										</div>
										<div class="form-group" data-validate="cannot be empty">
											<label for="birthDate" class="col-sm-3 control-label">Date of Birth*</label>
											<div class="col-sm-9">
												<input type="date" id="birthDate" required value="<?php echo $record['dateo_birth']; ?>" name="dbirth" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="phoneNumber" class="col-sm-3 control-label">Phone number </label>
											<div class="col-sm-9">
												<input type="phoneNumber" value="<?php echo $record['phonenumber']; ?>" required name="phonenumber" id="phoneNumber" placeholder="Phone number" class="form-control">
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" value="<?php echo $record['occupation']; ?>" id="occupation" required name="occupation" placeholder="Please write your occupation" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="address" class="col-sm-3 control-label">Address* </label>
											<div class="col-sm-9">
												<input type="text" value="<?php echo $record['address']; ?>" id="address" required name="address" placeholder="Please write your adress" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="image" class="col-sm-3 control-label">Image* </label>
											<div class="col-sm-9">
												<input type="file" value="<?php echo $record['image']; ?>" id="images"  name="image" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="email" class="col-sm-3 control-label">Nationality* </label>
											<div class="col-sm-9">
												<input type="text" id="nation" required value="<?php echo $record['nationality']; ?>" class="form-control" name="nationality">
											</div>
										</div>
										<div class="form-group">
												...
												<div class="row">
													<div class="col-sm-4">
														<label class="radio-inline">
															<input type="radio" value="<?php echo $record['gender']; ?>" name="mradio" id="femaleRadio" value="Female" checked required>Female
														</label>
													</div>
													<div class="col-sm-4">
														<label class="radio-inline">
															<input type="radio" value="<?php echo $record['gender']; ?>" name="mradio" id="maleRadio" value="Male" checked required>Male
														</label>
													</div>
												</div>
											</div>
