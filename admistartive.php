	...
	<section class="inner-page" style="margin-bottom: 30px;">
		<div class="container">
			<div class="page-title">
				<h1>Adminstration / <span>Secetariat</span></h1>
			</div><!-- Page Title -->
			<div class="turn">
				<div class="row">
					<div class="col-md-5 col-sm-5 col-5 clearfix offset-2" style="text-align: center;">
						<img src="images/Bawa Yusuf.jpg" class="img-circle" width="200px" height="200px">
						<h3>Mr. Emmanuel I.</h3>
						<p>Cheif Operating Officer</p>
					</div>
					<div class="col-md-5 col-sm-5 col-5 clearfix offset-2" style="text-align: center;">
						<img src="images/amaka.JPG" class="img-circle" width="200px" height="200px">
						<h3>Mrs. Seconda Amaka</h3>
						<p>Adminstrative Secetary</p>
					</div>
				</div>
			</div>
		</div>
